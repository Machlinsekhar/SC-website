    ...
    <div className="container my-10">
      <div className="flex flex-col md:grid grid-cols-9 mx-auto p-2 text-blue-50">
        ...
        <div className="flex flex-row-reverse md:contents">
          <div className="bg-[#AA4EC3] col-start-1 col-end-5 p-4 rounded-xl my-4 ml-auto shadow-md">
...
Assessment </h3>
          ...
          <div className="col-start-5 col-end-6 md:mx-auto relative mr-10">
            <div className="h-full w-6 flex items-center justify-center">
              <div className="h-full w-1 bg-[#AA4EC3] pointer-events-none"></div>
            </div>
            <div className="w-6 h-6 absolute top-1/2 -mt-3 rounded-full bg-[#AA4EC3] shadow"></div>
          </div>
        </div>
        ...
        <div className="flex md:contents">
          ...
          <div className="bg-[#AA4EC3] col-start-6 col-end-10 p-4 rounded-xl my-4 mr-auto shadow-md">
